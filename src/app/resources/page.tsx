      ...
      <section className="section-padding bg-off-white dark:bg-charcoal/30">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12">
            {[
              { icon: GraduationCap, title: "For Business Owners", desc: "Practical guides and tips to understand web design, SEO, and digital marketing — no technical jargon." },
              { icon: BookOpen, title: "For Ongoing Clients", desc: "Quick references, documentation, and support materials for our current partners." }
            ].map((item, index) => (
              <motion.div 
                key={index}
